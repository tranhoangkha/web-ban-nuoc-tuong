<?php
    class Paginator{
		var $base_url = ''; //link phân trang của website :URL."index.php/backend/catList/"
		...
		public function createLinks() {
			...
			$html  .= "<li class='page-item'><a aria-label='Previous'  class='page-link disabled'  href='".$this->base_url . ($this->cur_page - 1) . "'><span aria-hidden='true'>&laquo;</span></a></li>";
